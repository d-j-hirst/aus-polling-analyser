...
public:
	...
	std::string loadZippedFile(std::string url, std::string newFileName, bool getPollingDistricts = false);

	std::string unzipFile(std::string fileName, std::string newFileName, bool getPollingDistricts = false);
