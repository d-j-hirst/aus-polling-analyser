...
void DisplayFrame::render(wxDC& dc) {
	...
	dc.DrawRoundedRectangle(probTextRect, TextBoxCornerRounding);
	setBrushAndPen(*wxBLACK, dc);
	dc.DrawLabel("ALP leads", probTextRect, wxALIGN_CENTRE);
	probTextRect.Offset(0, ProbabilityBoxTextHeight + ProbabilityBoxTextPadding);
	setBrushAndPen(*wxWHITE, dc);
	dc.DrawRoundedRectangle(probTextRect, TextBoxCornerRounding);
	setBrushAndPen(*wxBLACK, dc);
	dc.DrawLabel("Ties", probTextRect, wxALIGN_CENTRE);
	probTextRect.Offset(0, ProbabilityBoxTextHeight + ProbabilityBoxTextPadding);
	setBrushAndPen(*wxWHITE, dc);
	dc.DrawRoundedRectangle(probTextRect, TextBoxCornerRounding);
	setBrushAndPen(*wxBLACK, dc);
	dc.DrawLabel("LNP leads", probTextRect, wxALIGN_CENTRE);
	probTextRect.Offset(0, ProbabilityBoxTextHeight + ProbabilityBoxTextPadding);
	setBrushAndPen(*wxWHITE, dc);
	dc.DrawRoundedRectangle(probTextRect, TextBoxCornerRounding);
	setBrushAndPen(*wxBLACK, dc);
	...
	dc.DrawRoundedRectangle(probDataRect, TextBoxCornerRounding);
	setBrushAndPen(*wxBLACK, dc);
	dc.DrawLabel(formatFloat(sim->partyOneLeadPercent, 2) + "%", probDataRect, wxALIGN_CENTRE);
	probDataRect.Offset(0, ProbabilityBoxTextHeight + ProbabilityBoxTextPadding);
	setBrushAndPen(*wxWHITE, dc);
	dc.DrawRoundedRectangle(probDataRect, TextBoxCornerRounding);
	setBrushAndPen(*wxBLACK, dc);
	dc.DrawLabel(formatFloat(sim->tiePercent, 2) + "%", probDataRect, wxALIGN_CENTRE);
	probDataRect.Offset(0, ProbabilityBoxTextHeight + ProbabilityBoxTextPadding);
	setBrushAndPen(*wxWHITE, dc);
	dc.DrawRoundedRectangle(probDataRect, TextBoxCornerRounding);
	setBrushAndPen(*wxBLACK, dc);
	dc.DrawLabel(formatFloat(sim->partyTwoLeadPercent, 2) + "%", probDataRect, wxALIGN_CENTRE);
	probDataRect.Offset(0, ProbabilityBoxTextHeight + ProbabilityBoxTextPadding);
	setBrushAndPen(*wxWHITE, dc);
	dc.DrawRoundedRectangle(probDataRect, TextBoxCornerRounding);
	setBrushAndPen(*wxBLACK, dc);
